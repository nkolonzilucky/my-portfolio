...
export default function ContactForm() {
    ...
    return (
        ...
        <form onSubmit={handleSubmit} className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
          <input value={formData.name} onChange={handleChange} type="text" placeholder="Name" className="p-2 bg-gray-700 rounded" required />
          <input value={formData.email} onChange={handleChange} type="email" placeholder="Email" className="p-2 bg-gray-700 rounded" required />
          <textarea value={formData.message} onChange={handleChange} placeholder="Message" className="p-2 bg-gray-700 rounded col-span-2" required />
